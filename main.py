...
from metric import Recall, NDCG, MRR, Jaccard
...
def main():
    ...
    train_loader = DataLoader(bundle_train_data, 32, True,
    ...
    #  metric
    metrics = [Recall(30), Recall(50), NDCG(30), NDCG(50), Jaccard(30), Jaccard(50)]
    TARGET = 'Recall@30'
